...
def gmute(bot: Bot, update: Update, args: List[str]):
    ...
    if int(user_id) in SUPPORT_USERS:
        message.reply_text("Ooof someone trying to gmute a support user! <b>*🍿🍿 Grabs Popcorn 🍿🍿*</b>")
        return

    if user_id == bot.id:
        message.reply_text("-_- So funny, Lets gmute myself 😒😑, Never forget, If you are <b>Bad</b>, then I'm your <b>Dad</b>. 👿👿")
        return
    ...
    message.reply_text("<b><i>😉😉 *Gets Duct Tape ready 😷* 😉😉</i></b>")
    ...
    for chat in chats:
        ...
        try:
            ...
            if excp.message == "User is an administrator of the chat 😪":
                ...
                pass
            elif excp.message == "Need to be inviter of a user to Kick him/her from a basic group 🥱🥱":
                pass
